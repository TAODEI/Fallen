...
class L10:
    def __init__(self):
        ...
        self.time_count = 0
        # 背景
        self.background = setup.GRAPHICS['10.1']
        # 掉落人的高度
    ...
    def update(self, surface: Surface, keys, dic) -> object:
        ...
        if not self.isOK[0]:
            if 'down' in dic:
                self.time_count = 0
                self.isOK[0] = True
                self.background = setup.GRAPHICS['10.2']
            ...
            if 'down' in dic:
                self.time_count = 0
                self.isOK[1] = True
                self.background = setup.GRAPHICS['10.3']
            surface.blit(self.background, surface.get_rect())
        # 变为指定图像
            ...
            if 'down' in dic:
                self.time_count = 0
                self.isOK[2] = True
                self.background = setup.GRAPHICS['10.4']
            surface.blit(self.background, surface.get_rect())
        # 消失两个人
            ...
            if 'down' in dic:
                self.time_count = 0
                self.isOK[3] = True
                self.background = setup.GRAPHICS['10.5']
            surface.blit(self.background, surface.get_rect())
        # 小男孩推出战场
            ...
            if 'down' in dic:
                self.time_count = 0
                self.isOK[4] = True
                self.background = setup.GRAPHICS['10.6']
            surface.blit(self.background, surface.get_rect())
        elif not self.isOK[5]:
            if 'down' in dic:
                self.time_count = 0
                self.isOK[5] = True
                self.background = setup.GRAPHICS['10.7']
            surface.blit(self.background, surface.get_rect())
        elif not self.isOK[6]:
            if 'down' in dic:
                self.time_count = 0
                self.isOK[6] = True
                self.background = setup.GRAPHICS['10.8']
            surface.blit(self.background, surface.get_rect())
        elif not self.isOK[7]:
            if 'down' in dic:
                self.time_count = 0
                self.isOK[7] = True
                self.background = setup.GRAPHICS['10.9']
            surface.blit(self.background, surface.get_rect())
        elif not self.isOK[8]:
            if 'down' in dic:
                self.time_count = 0
                self.isOK[8] = True
                self.background = setup.GRAPHICS['10.10']
            surface.blit(self.background, surface.get_rect())
        elif not self.isOK[9]:
            if 'down' in dic:
                self.time_count = 0
                self.isOK[9] = True
                self.background = setup.GRAPHICS['10.11']
            surface.blit(self.background, surface.get_rect())
